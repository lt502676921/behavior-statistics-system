...
const { categoryOrActionEmptyFailInfo, startDateOrEndDateEmptyFailInfo } = require('../res-model/failInfo/index')
...
async function getSearchData(eventKey, startDate, endDate) {
  // 检验数据
  if (!startDate || !endDate) return new ErrorRes(startDateOrEndDateEmptyFailInfo)
